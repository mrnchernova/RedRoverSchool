...
public class MonthUtils {
    ...
    public static final Month JUN = new Month("June", 30, 21);
    public static final Month JUL = new Month("July", 31, 23);
    public static final Month AUG = new Month("August", 31, 21);
    public static final Month SEP = new Month("September", 30, 22);
    public static final Month OCT = new Month("October", 31, 23);
    public static final Month NOV = new Month("November", 30, 20);
    public static final Month DEC = new Month("December", 31, 23);
